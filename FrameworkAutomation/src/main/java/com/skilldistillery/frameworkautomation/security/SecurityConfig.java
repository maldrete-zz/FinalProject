package com.skilldistillery.frameworkautomation.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET, "/api/templates/**").permitAll()   // allows permission to get templates for all users including anonymous 
